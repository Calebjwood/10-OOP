    ...
    run(){
        ...
        .prompt([
                ...
                .then((res) => {
                 ...
                 .then(()=> createDocument(determineShape(this.shape, this.color), this.name, this.text))
                 .then(() => fs.writeFile(`${this.name}.svg`,createDocument(determineShape(this.shape, this.color), this.name, this.text), (err) => 
